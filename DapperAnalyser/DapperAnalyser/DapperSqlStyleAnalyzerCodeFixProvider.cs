...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(DapperSqlStyleAnalyzerCodeFixProvider)), Shared]
    public class DapperSqlStyleAnalyzerCodeFixProvider : CodeFixProvider
    {
        private const string title = "Correct SQL Style";
            ...
            CancellationToken cancellationToken)
        {
            ...
            var newName = SqlStringStyleFixer.Fix(typeDecl.Token.ValueText);
