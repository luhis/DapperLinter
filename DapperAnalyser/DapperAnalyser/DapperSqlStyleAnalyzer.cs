...
namespace DapperAnalyser
{
    ...
    public class DapperSqlStyleAnalyzer : DiagnosticAnalyzer
    {
        public const string DiagnosticId = "DapperSqlStyleAnalyser";

        // You can change these strings in the Resources.resx file. If you do not want your analyzer to be localize-able, you can use regular strings for Title and MessageFormat.
        // See https://github.com/dotnet/roslyn/blob/master/docs/analyzers/Localizing%20Analyzers.md for more on localization
        private static readonly LocalizableString Title = new LocalizableResourceString(nameof(Resources.SqlStyleAnalyzerTitle), Resources.ResourceManager, typeof(Resources));
        private static readonly LocalizableString MessageFormat = new LocalizableResourceString(nameof(Resources.SqlStyleAnalyzerMessageFormat), Resources.ResourceManager, typeof(Resources));
        private static readonly LocalizableString Description = new LocalizableResourceString(nameof(Resources.SqlStyleAnalyzerDescription), Resources.ResourceManager, typeof(Resources));
        ...
        private void AnalyzeMethod(SyntaxNodeAnalysisContext context)
        {
            ...
            if (query.Expression is LiteralExpressionSyntax lit && !SqlStringStyleValidator.IsValid(lit.Token.ValueText))
            {
            ...
            else if (query.Expression is IdentifierNameSyntax ident)
            {
                ...
                if (value.HasValue && !SqlStringStyleValidator.IsValid(value.Value as string))
                {
